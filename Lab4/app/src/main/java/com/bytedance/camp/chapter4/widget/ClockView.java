...
public class ClockView extends View {
    ...
    private void drawTimeNeedles(Canvas canvas) {
        ...
        canvas.drawLine(getWidth() / 2, getHeight() / 2, getWidth() / 2, getHeight() / 2 - radius*HOUR_NEEDLE_LENGTH_RATIO, needlePaint);

        canvas.restore();
        canvas.save();
        needlePaint.setStrokeWidth(MINUTE_NEEDLE_WIDTH);
        canvas.rotate(minAngle,getWidth() / 2, getHeight() / 2);
        canvas.drawLine(getWidth() / 2, getHeight() / 2, getWidth() / 2, getHeight() / 2 - radius*MINUTE_NEEDLE_LENGTH_RATIO , needlePaint);

        canvas.restore();
        canvas.save();
        needlePaint.setStrokeWidth(SECOND_NEEDLE_WIDTH);
        canvas.rotate(secAngle,getWidth() / 2, getHeight() / 2);
        canvas.drawLine(getWidth() / 2, getHeight() / 2, getWidth() / 2, getHeight() / 2 - radius*SECOND_NEEDLE_LENGTH_RATIO , needlePaint);
